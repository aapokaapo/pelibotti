...
The bot also accepts legacy keys `MAP_POOLS` and `ALL_FIXTURES`, and legacy fixture entries with `opponent`, and normalizes them to the same internal format. For team-based filtering, legacy entries must include `team`; otherwise they are ignored.
