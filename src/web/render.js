...
<body>
  <main>${body}</main>
  <script>
    for (const form of document.querySelectorAll('form[data-csrf-form="true"]')) {
    ...
    <section class="stack">
      ...
      <div class="card">
        ...
        <ul>
          ...
          <li>Run <code>/set_default_dates</code>, <code>/set_auto_schedule</code>, and optionally <code>/set_auto_schedule_time</code> to configure weekly automation.</li>
        </ul>
      </div>
      <div>
